...
public class IWCBDeferredRegistryHandler {
	...
	public static final RegistryObject<CreativeModeTab> IWCB_TAB = CREATIVE_MODE_TABS.register("iwcompatbridge_tab", () -> CreativeModeTab.builder()
	...
	public static void setupCreativeTabs(BuildCreativeModeTabContentsEvent event) {
		if (event.getTab() == IWCBDeferredRegistryHandler.IWCB_TAB.get()) {
			Collection<RegistryObject<Item>> registryObjects = IWCBItemRegistry.ITEMS.getEntries();
